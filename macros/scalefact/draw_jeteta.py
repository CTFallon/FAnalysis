...
#run from FAnalysis folder with python macros/scalefact/draw_jeteta.py
...
c = rt.TCanvas()
for yearKey in ["16","17","18PRE","18POST"]:
	dictOfRatios_pt0["Bkg"+yearKey].SetMinimum(0)
	...
	title.Draw()
	c.BuildLegend()
	c.SaveAs(direct+yearKey+"_eta0_ratio.png")
	c.Clear()

for yearKey in ["16","17","18PRE","18POST"]:
	dictOfRatios_pt1["Bkg"+yearKey].SetMinimum(0)
	...
	title.Draw()
	c.BuildLegend()
	c.SaveAs(direct+yearKey+"_eta1_ratio.png")
	c.Clear()

for yearKey in ["16","17","18PRE","18POST"]:
	dictOfRatios_ptb["Bkg"+yearKey].SetMinimum(0)
	...
	title.Draw()
	c.BuildLegend()
	c.SaveAs(direct+yearKey+"_etab_ratio.png")
	c.Clear()

for yearKey in ["16","17","18PRE","18POST"]:
	dictOfSF_pt0[yearKey].SetMinimum(0)
