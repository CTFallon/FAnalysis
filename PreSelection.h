...
// Thu May 25 15:09:49 2017 by ROOT version 6.06/01
// from TTree PreSelection/PreSelection
// found on file: ../TreeMaker/Production/test/T1tttt16_RA2AnalysisTree.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../TreeMaker/Production/test/T1tttt16_RA2AnalysisTree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../TreeMaker/Production/test/T1tttt16_RA2AnalysisTree.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../TreeMaker/Production/test/T1tttt16_RA2AnalysisTree.root:/TreeMaker2");
